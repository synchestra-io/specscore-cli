...
// ---------------------------------------------------------------------------
// walk.go — lines 13-15: Discover fails → Walk returns error (stub-based)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// walk.go — lines 18-20: Parse fails → Walk returns error (stub-based)
// ---------------------------------------------------------------------------
...
func TestWalk_ParseError_Stub(t *testing.T) {
	...
	discoverFn = func(specRoot string) ([]Discovered, error) {
		return []Discovered{{Slug: "bad", Path: "/fake/bad.property.md"}}, nil
	}
...
// ---------------------------------------------------------------------------
// discover.go — lines 38-40: walkErr non-nil in callback (stub-based)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// discover.go — lines 55-57: Walk returns non-nil error (stub-based)
// ---------------------------------------------------------------------------

...
>
> **AI skill:** [GitHub](https://github.com/specscore/ai-plugin-specscore/blob/main/skills/feature/references/list.md) · [local](../../../../../../ai-plugin-specscore/skills/feature/references/list.md) — if this command's CLI signature or behavior changes, update the linked skill to keep agents in sync.
